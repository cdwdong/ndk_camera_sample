...
//            1.0f, 0.0f,
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        if(mCallback != null) mCallback.surfaceCreated(null);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(mWorkQueueLock != null && mWorkQueueLock.tryAcquire()) {
        ...
        if(mMatData != null && !mMatData.empty()){
...
//            Log.d(TAG, "Mat Info : " + mMatData + mMatData.total());
//            //Draw Mat Native
